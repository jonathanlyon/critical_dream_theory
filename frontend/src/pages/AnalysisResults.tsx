        ...
        <section className="card">
          <div className="flex items-start gap-6">
            ...
            <div className="hidden lg:block w-48 h-48 rounded-lg bg-gradient-to-br from-primary-600/30 to-secondary-600/30 flex-shrink-0 overflow-hidden">
              {analysis.dreamImage?.url ? (
                <img
                  src={analysis.dreamImage.url}
                  alt={analysis.overview.title}
                  className="w-full h-full object-cover"
                  title={analysis.dreamImage.prompt}
                />
              ) : (
                <div className="w-full h-full flex items-center justify-center text-gray-500">
                  {analysis.dreamImage?.status === 'failed' ? (
                    <div className="text-center p-2">
                      <svg className="w-8 h-8 mx-auto mb-1 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
